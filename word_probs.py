...
def is_word_possible(vocab, target_word, start):
    ...
    for i in xrange(0,len(target_word)):
        ...
        if target_word[start:start + i] in vocab_set:
            if is_word_possible(vocab, target_word, start + i):
                return True
